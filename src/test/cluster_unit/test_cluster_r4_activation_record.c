...
/* The SQL entry pgrac_r4_bit22_cutover_begin (增量 48 step ④e) references
...
/* The member-side bit22 cutover path (RF-ROOT P9 audit #2 redo part 3,
...
UT_TEST(test_64_shmem_size_includes_exact_ack_table)
{
	Size expected = MAXALIGN(sizeof(ClusterSemanticActivationShmem))
					...
					/* 增量 61/62: online first-open via the source-close
					 * BARRIER. */
